...
{
    internal sealed class ShootingSystem
    {
        ...
        internal ShootingSystem(Data data, Transform player, SoundFactory soundFactory, Controllers controllers, IUserKeyInput keyInput)
        {
            _data = data;
            _player = player;
